...
class FlaskTestCase(unittest.TestCase):
    ...
    def test_incorrect_login(self):
        ...
        self.assertTrue('Please try again' in response.data)
    ...
    # Ensure that the logout page requires user to be logged in
    def test_logout_page_requires_login(self):
        tester = app.test_client(self)
        response = tester.get('/logout', follow_redirects=True)
        self.assertTrue('You need to login first' in response.data)

    # alternatively could use "assertIn"
    ...
    def test_post_show_up(self):
        ...
        self.assertIn('Shell Test', response.data)
